 ...
 *
 * file:        "$URL: http://svn.openehr.org/ref_impl_java/TRUNK/libraries/src/test/org/openehr/am/archetype/output/ADLOutputterTest.java $"
 * revision:    "$LastChangedRevision: 40 $"
 * last_change: "$LastChangedDate: 2006-07-12 02:04:57 +0200 (Wed, 12 Jul 2006) $"
 */
/**
 * ADLOutputterTest
 *
...
public class ADLSerializerTest extends TestCase {
	
	/* static fields */
	private static final CodePhrase ENGLISH = new CodePhrase("iso-639", "en");

    public ADLSerializerTest(String test) {
        super(test);
    }
    ...
    public void testPrintDescriptionItem() throws Exception {
        ...
        ArchetypeDescriptionItem item = new ArchetypeDescriptionItem(
                ENGLISH, purpose, use, misuse, copyright,
    ...
    public void testPrintDescription() throws Exception {
        ...
        ArchetypeDescriptionItem item = new ArchetypeDescriptionItem(
                ENGLISH, "purpose of this archetype");
        items.add(item);
    ...
    /* field */
    private ADLSerializer outputter;
 ...
 *  License.
 *
 *  The Original Code is ADLSerializerTest.java
 *
