...
public abstract class ITEM  extends org.openehr.schemas.v1.LOCATABLE  implements java.io.Serializable {
    public ITEM() {
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://schemas.openehr.org/v1", "ITEM"));
    }
