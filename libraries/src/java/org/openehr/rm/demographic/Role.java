...
public class Role extends Party {
    ...
    @FullConstructor
            public Role(@Attribute(name = "uid", required = true) ObjectID uid,
                        ...
                        @Attribute(name = "reverseRelationships") Set<ObjectReference> reverseRelationships,
                        ...
                        @Attribute(name = "performer", required = true) Actor performer) {
    ...
    protected void setPerformer(Actor performer) {
        this.performer = performer;
    }
    ...
    public Locatable itemAtPath(String path) {
        ...
        ret = checkAttribute(tmp, "performer", performer);
        if(ret != null) {
            return ret;
        }
    ...
    public boolean equals(Object o) {
        ...
        return new EqualsBuilder()
                ...
                .append(performer.getUid(), role.performer.getUid())
                .isEquals();
    }
