 ...
 *
 * file:        "$URL: http://svn.openehr.org/ref_impl_java/TRUNK/libraries/src/java/org/openehr/rm/ehr/Folder.java $"
...
public class Folder extends Locatable {
    ...
    public Folder(ObjectID uid, String archetypeNodeId, DvText name,
                  ...
                  FeederAudit feederAudit, Set<Link> links, Locatable parent,
