 ...
 * description: "Class RMObjectBuilderDataTypesTest"
 * keywords:    "unit test"
 *
...
public class RMObjectBuilderDataTypesTest extends RMObjectBuilderTestBase {
    ...
    public RMObjectBuilderDataTypesTest(String test) {
        super(test);
    }
 ...
 *  License.
 *
 *  The Original Code is RMObjectBuilderDataTypesTest.java
 *
