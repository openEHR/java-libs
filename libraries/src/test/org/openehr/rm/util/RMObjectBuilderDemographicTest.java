 ...
 * description: "Class RMObjectBuilderDemographicTest"
 * keywords:    "unit test"
 *
...
public class RMObjectBuilderDemographicTest extends RMObjectBuilderTestBase {
    ...
    public RMObjectBuilderDemographicTest(String test) {
        super(test);
    }
 ...
 *  License.
 *
 *  The Original Code is RMObjectBuilderDemographicTest.java
 *
