...
public class VersionedPartyTest extends DemographicTestBase {
    ...
    private AuditDetails audit(DvCodedText changeType) throws Exception {
        ...
        DvCodedText codedText = new DvCodedText("code value", ENGLISH,
    ...
    private static final CodePhrase ENGLISH = 
    	new CodePhrase(new TerminologyID("iso-639-2"), "en");
    
    private static final CodePhrase LATIN_1 = 
    	new CodePhrase(new TerminologyID("iana-character sets"), "ISO-8859-1");    
}
/*
 *  ***** BEGIN LICENSE BLOCK *****
