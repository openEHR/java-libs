 ...
 * description: "Class GenerationStrategy"
...
public enum GenerationStrategy {
	...
	/**
	 * Minimum structure with default or mock data values
	 */
	MINIMUM, 
	
	/**
	 * Maximum structure with default or mock data values
	 */
	MAXIMUM,
	
	/**
	 * Maximum structure with empty data elements
	 */
	MAXIMUM_EMPTY
}
/*
 ...
 * 
 * The Original Code is GenerationStrategy.java
 * 
