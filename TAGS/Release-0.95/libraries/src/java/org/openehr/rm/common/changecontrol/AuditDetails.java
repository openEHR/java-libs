...
public class AuditDetails extends RMObject {
     ...
     */
    public AuditDetails(String systemId, PartyReference committer,
        ...
        if (!terminologyService.terminology("openehr").hasCodeForGroupName(
                changeType.getDefiningCode(), "audit change type", "en")) {
     ...
     * @return committer
     */
    public PartyReference getCommitter() {
        return committer;
    }
    ...
    void setCommitter(PartyReference committer) {
        this.committer = committer;
    }
    ...
    private PartyReference committer;
