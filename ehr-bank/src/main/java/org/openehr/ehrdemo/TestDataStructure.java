...
public class TestDataStructure {
	...
	protected static Cluster cluster(String archetypeNodeId, String name,
			List<Item> items) {
		return new Cluster(archetypeNodeId, text(name), items);
	}

	// create an element by same name, value and code
	protected static Element element(String name) {
		return element("at0100", name, name, name);
	}

	// create an element by name and code
	protected static Element element(String name, String code) {
		return element("at0100", name, code, code);
	}

	// create an element by name and value
	protected static Element element(String name, DataValue value) {
		return new Element("at0101", text(name), value);
	}

	// create an element by name, and ratio
	protected static Element element(String name, double numerator, double denominator) {
		return element(name, proportion(numerator, denominator));
	}

	// create an element with text value
	protected static Element element(String archetypeNodeId, String name, String value) {
		return new Element(archetypeNodeId, text(name), text(value));
	}

	// create an element with codedText value
	protected static Element element(String archetypeNodeId, String name,
	...
	protected static Element element(String archetypeNodeId, String name, double value) {
		return new Element(archetypeNodeId, text(name), new DvQuantity(value));
	}

	// create a text
	protected static DvText text(String value) {
		return new DvText(value);
	}

	// create a codeText
	protected static DvCodedText codedText(String value, String code) {
	...
	protected static DvProportion proportion(double numerator, double denominator) {
