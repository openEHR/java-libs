...
/**
 * Mock implementation of TerminologyAccess
 * 
 * @author Rong Chen
 * @version 1.0
 */
public class TestTerminologyAccess implements TerminologyAccess {
    ...
    public static final CodePhrase RELATIONS = new CodePhrase(
    		TerminologyService.OPENEHR, 
    		TerminologyGroupIdentifier.RELATED_PARTY_RELATIONSHIP.toString());
    public static final CodePhrase SETTING = new CodePhrase(
    		TerminologyService.OPENEHR,
    		TerminologyGroupIdentifier.SETTING.toString());
    public static final CodePhrase FUNCTION = new CodePhrase(
    		TestTerminologyService.OPENEHR, 
    		TerminologyGroupIdentifier.PARTICIPATION_FUNCTION.toString());
    public static final CodePhrase CHANGE = new CodePhrase(TerminologyService.OPENEHR, 
            "changeTypeCode");
    ...
    public static final CodePhrase ENGLISH = new CodePhrase("iso639-2", "en");
    public static final CodePhrase LATIN_1 = new CodePhrase(
    		TerminologyService.OPENEHR, "iso-8859-1");
    public static final CodePhrase NULL_FLAVOUR = new CodePhrase(
    		TestTerminologyService.OPENEHR, "unanswered");
    
    static final CodePhrase EVENT_MATH_MEAN = new CodePhrase(
    		TerminologyService.OPENEHR, "mean");
